 ...
 * {@link PromocodeFragment.OnFragmentInteractionListener} interface
...
public class PromocodeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        promoListView = (ListView) view.findViewById(R.id.listPromo);
        notificationArrayList = db.getAllPromo();
        promoListView.setAdapter(new PromoListAdapter(notificationArrayList, getActivity()));
