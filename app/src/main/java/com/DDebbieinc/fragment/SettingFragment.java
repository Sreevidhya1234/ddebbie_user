...
import com.DDebbieinc.util.CircleTransform;
...
public class SettingFragment extends Fragment {
    ...
    private Button mBtbEdit;
    public static TextView mTxtName, mTxtEmail, mTxtMobile;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBtbEdit = (Button) view.findViewById(R.id.btnEditProfile);
        ...
        imgProfilePic = (CircleImageView) view.findViewById(R.id.profile_image);

        IOUtils ioUtils = new IOUtils(getContext());
        userDetailsPojo = ioUtils.getUser();

        mTxtName.setText(userDetailsPojo.getCustomerName());
        mTxtEmail.setText(userDetailsPojo.getEmail());
        mTxtMobile.setText(userDetailsPojo.getContactNumber());
        ...
        mBtbEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                FragmentTransaction fragmentTransaction = getFragmentManager().beginTransaction();
                EditProfileFragment editProfileFragment = new EditProfileFragment();
                fragmentTransaction.addToBackStack(editProfileFragment.getClass().getName());
    ...
    public void setDP(){
        ...
        if(!util.getDP().equals("")) {
            Picasso.with(getActivity()).load(util.getDP()).transform(new CircleTransform())
    ...
    private void selectImage() {
        ...
        builder.setItems(options, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                {
                    mListener.onFragmentInteraction("Take Photo");

                } else if (options[item].equals("Choose from Gallery"))

                {
                    mListener.onFragmentInteraction("Choose from Gallery");
